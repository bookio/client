...
define(['./sprintf.js'], function() {
	...
	Date.prototype.addDays = function (value) {
	    return this.addMilliseconds(value * 24 * 60 * 60 * 1000);
	};
	
	Date.prototype.addWeeks = function (value) {
	    return this.addMilliseconds(value * 7 * 24 * 60 * 60 * 1000);
	};
	...
	Date.prototype.addMonths = function (value) {
	    ...
	    date.setDate(Math.min(this.getDate(), date.getDaysInMonth()));
	    return date;
	};
